...
export const SALES_ORDER_STATUS = {
  ...
  INSTALLED: "INSTALLED",
  ON_HOLD: "ON_HOLD",
  /** The old name for Dispatched. Orders raised before the fulfilment
      chain existed still carry it. */
  RELEASED: "RELEASED",
  COMPLETED: "COMPLETED",
  CANCELLED: "CANCELLED",
} as const;
...
/** The fulfilment chain in order, for the progress strip. */
export const SALES_ORDER_PIPELINE: SalesOrderStatus[] = [
  SALES_ORDER_STATUS.DRAFT,
  SALES_ORDER_STATUS.PENDING_APPROVAL,
  SALES_ORDER_STATUS.CONFIRMED,
  SALES_ORDER_STATUS.PAYMENT_VERIFIED,
  SALES_ORDER_STATUS.PROCUREMENT,
  SALES_ORDER_STATUS.READY,
  SALES_ORDER_STATUS.DISPATCHED,
  SALES_ORDER_STATUS.DELIVERED,
  SALES_ORDER_STATUS.INSTALLED,
...
export const SALES_ORDER_TRANSITIONS: Record<SalesOrderStatus, SalesOrderStatus[]> =
  {
    ...
    CONFIRMED: ["PAYMENT_VERIFIED", "ON_HOLD", "CANCELLED"],
    PAYMENT_VERIFIED: ["PROCUREMENT", "ON_HOLD", "CANCELLED"],
    PROCUREMENT: ["READY", "ON_HOLD", "CANCELLED"],
    READY: ["DISPATCHED", "ON_HOLD", "CANCELLED"],
    DISPATCHED: ["DELIVERED", "ON_HOLD", "CANCELLED"],
    DELIVERED: ["INSTALLED", "ON_HOLD", "CANCELLED"],
    INSTALLED: ["COMPLETED", "ON_HOLD", "CANCELLED"],
    RELEASED: ["DELIVERED", "COMPLETED", "ON_HOLD", "CANCELLED"],
    ON_HOLD: [...SALES_ORDER_PIPELINE, "RELEASED", "CANCELLED"],
    COMPLETED: [],
    CANCELLED: [],
  };
